...
$DscResourcePropertySubcategory = @{
    Name = 'Subcategory'
    Type = 'String'
    Attribute = 'Key'
    Description = 'The Category to be configured'
    ...
    'Other Logon/Logoff Events','Network Policy Server','User / Device Claims','Group Membership',
    'File System','Registry','Kernel Object','SAM','Certification Services','Application Generated',
    ...
    'Other Privilege Use Events','Sensitive Privilege Use','Process Creation','Process Termination',
    'DPAPI Activity','RPC Events','Plug and Play Events','Authentication Policy Change',
...
$Name = New-xDscResourceProperty @DscResourcePropertySubcategory

$DscResourcePropertyAuditType = @{
    Name = 'AuditType'
    Type = 'String'
    Attribute = 'Key'
...
$Setting = New-xDscResourceProperty @DscResourcePropertyAuditType


$DscResourcePropertyEnsure = @{
    Name = 'Ensure'
    Type = 'String'
    Attribute = 'Write' 
    Description = 'Describe the setting state'
    ValidateSet = @('Present','Absent')
}

$Ensure = New-xDscResourceProperty @DscResourcePropertyEnsure
