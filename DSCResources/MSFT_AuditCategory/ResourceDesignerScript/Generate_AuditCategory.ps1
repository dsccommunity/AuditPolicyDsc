...
$DscResourcePropertySubcategory = @{
    ...
    'Application Group Management', 'Other Account Management Events', 'Directory Service Changes', 
    'Directory Service Replication', 'Detailed Directory Service Replication',
    'Directory Service Access', 'Kerberos Service Ticket Operations', 'Other Account Logon Events', 
